...
<body>
    ...
    <?php if ($venta["forma_pago"] == "Credito") : ?>
        ...
        <table class="table mt-2">
            <thead>
                <tr>
                    <th style="width:20%;font-size: 14px;border: 1px solid #34495e;text-align: center;background-color: #34495e; color: white;font-weight: bold;">NRO CUOTA</th>
                    <th style="width:40%;font-size: 14px;border: 1px solid #34495e;text-align: center;background-color: #34495e; color: white;font-weight: bold;">IMPORTE</th>
                    <th style="width:20%;font-size: 14px;border: 1px solid #34495e;text-align: center;background-color: #34495e; color: white;font-weight: bold;">FEC VENC.</th>
                </tr>
            </thead>
            <tbody>
                ...
                <?php for ($i = 0; $i < count($cuotas); $i++) : ?>
                    <tr>
                        <td style="width:20%;font-size: 12px;border: 1px solid #34495e;text-align: center;"><?php echo $cuotas[$i]["cuota"]; ?></td>
                        <td style="width:40%;font-size: 12px;border: 1px solid #34495e;text-align: center;"><?php echo $cuotas[$i]["importe"]; ?></td>
                        <td style="width:20%;font-size: 12px;border: 1px solid #34495e;text-align: center;"><?php echo $cuotas[$i]["fecha_vencimiento"]; ?></td>
                    </tr>
