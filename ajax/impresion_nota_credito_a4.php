...
<body>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td style="font-size: 14px;border-color: #000;text-align: center;border-width: 5px;border-color: black;border-style: double;padding: 5px 15px;">
                                ...
                                <span>NOTA DE</span> <br>
                                <span>CRÉDITO</span> <br>
    ...
    <!-- DATOS DEL CLIENTE -->
    <table style="width: 100%;" class="rounded">
                        ...
                        <body>
                            <tr class="rounded">
                                ...
                                <td style="width: 70%;">
                                    ...
                                    <span style="font-size: 13px;"><?php echo $venta["fecha_emision"] ?></span>
                                </td>
                            </tr>
                        </body>
                    </table>
    ...
    <table style="width: 100%;" class="rounded">
        <thead>
            <tr style="font-size: 14px;text-align: left;background-color: #34495e; color: white;font-weight: bold;">
                <th>
                    <span style="margin-left: 10px;">COMPROBANTE AFECTADO</span>
                </th>
            </tr>
        </thead>
        <body>
                ...
                <td>
                    <table>
                        <body>
                            <tr class="rounded">
                                <td style="width: 30%;">
                                    <span style="margin-left: 10px;font-size: 13px;font-weight: bold;">COMPROBANTE:</span> <br>                                    
                                    <span style="margin-left: 10px;font-size: 13px;font-weight: bold;">MOTIVO NOTA CRÉDITO:</span><br>
                                    <span style="margin-left: 10px;font-size: 13px;font-weight: bold;">DESCRIPCIÓN NOTA CRÉDITO:</span>
                                </td>
                                <td style="width: 70%;">                                    
                                    <span style="font-size: 13px;"><?php echo $venta["serie_modificado"].'-'.$venta["correlativo_modificado"]; ?></span><br>
                                    <span style="font-size: 13px;"><?php echo $venta["motivo_nota"]; ?></span><br>
                                    <span style="font-size: 13px;"><?php echo $venta["descripcion_motivo_nota"]; ?></span><br>
                                </td>
                            </tr>
                        </body>
                    </table>
                    ...
                    <table style="width: 100%;">
                        ...
                        <body>
                            ...
                            <tr>
                                ...
                                <td style="width: 20%;;text-align: right; border: 1px solid #34495e;font-size: 12px;">
                                    <span style="margin-right: 15px;"><?php echo $venta["ope_gravada"] + $venta["ope_inafecta"] + $venta["ope_exonerada"] ?></span>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 80%;text-align: right; border: 1px solid #34495e;font-size: 12px;">
                            ...
                            <tr>
                                <td style="width: 80%;text-align: right; font-weight: bold;color: white; border: 1px solid #34495e;font-size: 12px;background-color: #34495e">
                                    <span style="margin-right: 15px;">TOTAL NOTA CRÉDITO</span>
                                </td>
                                <td style="width: 20%;;text-align: right; border: 1px solid #34495e;font-size: 12px;">
