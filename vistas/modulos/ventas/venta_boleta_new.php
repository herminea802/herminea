                ...
                <div class="row">
                        ...
                        <div class="form-group clearfix w-100 d-flex justify-content-start justify-content-lg-center my-0 ">
                            <div class="icheck-warning d-inline mx-2">
                                ...
                                <label for="rb-venta-envio">
                                    Generar Venta y Enviar Comprobante Electrónico (SUNAT)
                                </label>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body px-3 py-3" style="position: relative;">
                                ...
                                <div class="row my-1">
                                    ...
                                    <!-- <div class="col-12 col-lg-3">
                                        ...
                                        <div class="card card-gray shadow w-lg-100 float-right mt-2">

                                            <div class="card-body px-2 py-1 fw-bold" style="position: relative;">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-gray shadow w-lg-100 float-right">
                            ...
                            <div class="card-body px-2 py-0 fw-bold" style="position: relative;">

                                <div class="row my-1">

                                    <div class="col-lg-2 fs-5 text-center d-flex p-0 m-0 justify-content-center flex-column">
                                        <span>OP. GRAVADAS</span>
                                        <span id="resumen_opes_gravadas">S/
                                            0.00</span>
                                    </div>

                                    <div class="col-lg-2 fs-5 text-center d-flex justify-content-center flex-column">
                                        <span>OP. INAFECTAS</span>
                                        <span id="resumen_opes_inafectas">S/
                                            0.00</span>
                                    </div>

                                    <div class="col-lg-2 fs-5 text-center d-flex justify-content-center flex-column">
                                        <span>OP. EXONER.</span>
                                        <span id="resumen_opes_exoneradas">S/
                                            0.00</span>
                                    </div>
                                    ...
                                    <div class="col-lg-2 fs-5 text-center d-flex justify-content-center flex-column">
                                        <span>IGV</span>
                                        <span id="resumen_total_igv">S/ 0.00</span>
                                        <!-- <hr class="m-1" /> -->
                                    </div>

                                    <div class="col-lg-2 text-danger fs-4 text-center fw-bold d-flex justify-content-center flex-column">
                                        <span>TOTAL</span>
                                        <span id="resumen_total_venta">S/
                                            0.00</span>
                                    </div>
                        ...
                        <div class="card card-gray shadow w-lg-100 float-right">
                            ...
                            <div class="card-body px-2 py-0 fw-bold" style="position: relative;">
                                ...
                                <div class="row my-1 mx-2">
                                    ...
                                    <div class="col-lg-2 fs-5 text-center d-flex mb-2  justify-content-center flex-column">
                                        <span>EFECTIVO</span>
                                        <input type="number" min="0" step="0.01" placeholder="Vuelto" style="border-radius: 20px;" class="form-control form-control-sm" id="monto_pago_efectivo" name="monto_pago_efectivo" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                                    </div>
                                    ...
                                    <div class="col-lg-4 fs-5 text-center text-danger d-flex mb-2 justify-content-center flex-column">
                                        <span>SALDO</span>
                                        <input type="number" min="0" step="0.01" placeholder="Vuelto" style="border-radius: 20px;" class="form-control form-control-sm readonly" id="monto_pago_efectivo" name="monto_pago_efectivo" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                                    </div>
